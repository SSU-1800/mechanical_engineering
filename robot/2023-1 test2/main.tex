...
\title{\vspace{100pt}\textbf{\Huge 해설}}
\author{
	2023-1 동역학(이동훈 교수님) 기말고사\\[140pt]
}
\date{\today}
...
\spbox{\subsection*{Question 1}}
	...
	\vspace{\baselineskip}
	\hspace{20mm}\includegraphics{img/q01-1.png}
	\begin{align*}
...
\spbox{\subsection*{Question 3}}
{
	...
	\vspace{\baselineskip}
	\includegraphics{img/q03.png}\hspace{20mm}\includegraphics{img/q03-1.png}
	\vspace{\baselineskip}
	\begin{align*}
		&L = 0.15\meter,\quad l = 0.05\meter,\quad \dot{\theta} = 900\,\mathrm{rpm}\times\frac{1\,\mathrm{min}}{60\snd}\times\frac{2\pi\,(\mathrm{rad})}{1\,\mathrm{rev}} = 30\pi\snd^{-1}\\
